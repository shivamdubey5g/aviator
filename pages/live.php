...
<div class="live-page">
    <div class="card">
        <div class="card-header">
            ...
            <p>Real-time cricket scores and updates</p>
        </div>
        
        <div class="live-scores-container">
            <?php if ($liveMatches && isset($liveMatches['typeMatches'])): ?>
                <div class="matches-grid">
                    <?php foreach ($liveMatches['typeMatches'] as $typeMatch): ?>
                        <?php foreach ($typeMatch['seriesMatches'] as $series): ?>
                            ...
                            <?php foreach ($series['seriesAdWrapper']['matches'] as $match): ?>
                                ...
                                <div class="match-card live-match" data-match-id="<?php echo $matchInfo['matchId']; ?>">
            ...
            <?php else: ?>
                <div class="no-matches">
                    ...
                    <p>There are no live cricket matches at the moment. Check back later!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
